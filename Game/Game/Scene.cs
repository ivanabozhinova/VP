    ...
    public class Scene
    {
        ...
        public void showLives(Graphics g, Rectangle ClientRectangle)
        {
            if (numLives > 0)
            {
                ...
                g.DrawImage(lifeImg, ClientRectangle.X + 370, ClientRectangle.Y + ClientRectangle.Height - statusBarImg.Height * 2 / 3 + 25,
                ...
                if (numLives > 1)
                {
                    for (int i = 1; i < numLives; i++)
                        g.DrawImage(lifeImg,
                                    ClientRectangle.X + i * (lifeImg.Width + 12) + 255, ClientRectangle.Y + ClientRectangle.Height - statusBarImg.Height * 2 / 3 + 25,
